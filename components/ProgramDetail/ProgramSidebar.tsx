  ...
  return (
    <div className="lg:col-span-4 lg:sticky lg:top-24 space-y-6">
      ...
      <div className="card-premium p-8 rounded-[2rem] animate-fade-in-up delay-200 shadow-2xl">
        ...
        <p className="text-xs text-[var(--text-tertiary)] text-center mt-4 font-medium">
              ...
              <div className="flex items-start gap-3">
                ...
                <div className="space-y-1">
                  ...
                  <p className="text-[11px] text-gray-400 leading-relaxed font-medium">
                    You will be redirected to the official partner program
                    application page.
                  </p>
                </div>
              </div>
      ...
      <div className="card-premium p-6 rounded-[2rem] animate-fade-in-up delay-300">
        <h3 className="text-xs font-bold text-[var(--text-tertiary)] uppercase tracking-wider mb-5 pl-2">
          Links
        </h3>
